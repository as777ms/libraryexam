...
const News = () => {
  ...
  const [query, setQuery] = useState('happy'); // Initialize query to empty string
...
const FooterLink = styled(Link)(({ theme }) => ({
  ...
  return (
    ...
    <h1 style={{ fontSize: '3rem', fontWeight: 'bold', marginBottom: '1rem' }}>
        ...
        <p style={{ fontSize: '1.25rem', color: '#555' }}>364 подборки</p>
        <p style={{ fontSize: '1.1rem', lineHeight: '1.6', marginTop: '1rem' }}>
          На этой странице представлены 364 подборки последних новинок книг и аудиокниг от лучших авторов. Подборки обновляются каждую неделю, что позволит каждому читателю найти книгу по своему вкусу. Начните читать последние новинки прямо на сайте или установите наше удобное приложение, чтобы не расставаться с любимыми книгами даже при отсутствии подключения к интернету!
        </p>
